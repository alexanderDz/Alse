...
public:
    ...
    void setupUi(QMainWindow *Leds)
    {
        ...
        Leds->resize(360, 320);
        Leds->setMinimumSize(QSize(360, 320));
        Leds->setMaximumSize(QSize(360, 320));
        centralWidget = new QWidget(Leds);
        centralWidget->setObjectName(QStringLiteral("centralWidget"));
        groupBox = new QGroupBox(centralWidget);
        groupBox->setObjectName(QStringLiteral("groupBox"));
        groupBox->setGeometry(QRect(50, 10, 261, 221));
        ...
        layoutWidget2->setGeometry(QRect(30, 180, 201, 27));
        horizontalLayout = new QHBoxLayout(layoutWidget2);
        horizontalLayout->setSpacing(6);
        horizontalLayout->setContentsMargins(11, 11, 11, 11);
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        _cmdSign_in = new QPushButton(layoutWidget2);
        _cmdSign_in->setObjectName(QStringLiteral("_cmdSign_in"));

        horizontalLayout->addWidget(_cmdSign_in);

        _cmdLog_in = new QPushButton(layoutWidget2);
        _cmdLog_in->setObjectName(QStringLiteral("_cmdLog_in"));

        horizontalLayout->addWidget(_cmdLog_in);

        message_user = new QLabel(groupBox);
        message_user->setObjectName(QStringLiteral("message_user"));
        message_user->setGeometry(QRect(40, 0, 191, 20));
        label_info = new QLabel(centralWidget);
        label_info->setObjectName(QStringLiteral("label_info"));
        label_info->setGeometry(QRect(50, 240, 261, 20));
