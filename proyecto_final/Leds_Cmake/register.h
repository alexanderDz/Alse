...
private:
    Ui::Register *ui;
    string first_name; /**< Variable que almacena el nombre del usuario. */
    string last_name; /**< Variable que almacena el apellido del usuario. */
    int national_id; /**< Variable que almacena el documento del usuario. */
    int age; /**< Variable que almacena la edad del usuario. */
    string user_name; /**< Variable que almacena el username del usuario. */
    string psswd; /**< Variable que almacena el nombre del usuario. */
